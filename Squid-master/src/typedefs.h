...
//my code
//typedef struct _ofp_match ofp_match;
typedef union _rule_data rule_data;
typedef struct _rule_acl_var rule_acl_var;
typedef struct _rule_properties rule_properties;
typedef struct _basic_header basic_header;
typedef struct _rule_table rule_table;
